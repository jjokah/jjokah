...
- Continue to [AI Image Generation](ai-image-generation.md) to add visual content creation to your toolkit
- Create your brand voice guide this week using three pieces of writing you're proud of
- Build a prompt library of your most-used writing formats with voice guide pre-loaded
